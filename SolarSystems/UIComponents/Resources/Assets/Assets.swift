...
public enum Asset {
  public enum Colors {
    ...
    public static let appEarth = ColorAsset(name: "appEarth")
    public static let appGray = ColorAsset(name: "appGray")
    public static let appJupiter = ColorAsset(name: "appJupiter")
    public static let appMars = ColorAsset(name: "appMars")
    public static let appMercury = ColorAsset(name: "appMercury")
    public static let appNeptun = ColorAsset(name: "appNeptun")
    ...
    public static let appPink2 = ColorAsset(name: "appPink2")
    public static let appPurple1 = ColorAsset(name: "appPurple1")
    public static let appPurple2 = ColorAsset(name: "appPurple2")
    public static let appSaturn = ColorAsset(name: "appSaturn")
    public static let appUranus = ColorAsset(name: "appUranus")
    public static let appVenus = ColorAsset(name: "appVenus")
    public static let appWhite = ColorAsset(name: "appWhite")
    public static let appYellow1 = ColorAsset(name: "appYellow1")
    public static let appYellow2 = ColorAsset(name: "appYellow2")
  }
  public enum Icons {
    public static let icBack = ImageAsset(name: "icBack")
    public static let icDiscovery = ImageAsset(name: "icDiscovery")
    public static let icGo = ImageAsset(name: "icGo")
  ...
  public enum Images {
    ...
    public static let mercury = ImageAsset(name: "Mercury")
    public static let neptune = ImageAsset(name: "Neptune")
    ...
    public static let starsBackground = ImageAsset(name: "starsBackground")
  }
}
